...
#define REGISTER_MESSAGE(msg){msg,#msg} //msg: actual  message; #msg: the string of the message



//The BIG LIST of windows messages, which I got from this website: https://wiki.winehq.org/List_Of_Windows_Messages
...
//This will format everything nicely :)
